...
export class HomeSceneComponent implements AfterViewInit {
  ...
  private makeMenu(res: any) {
    ...
    this.lab.r.anchor.set(0.5); this.lab.g.anchor.set(0.5); this.lab.b.anchor.set(0.5);
    this.me.r.anchor.set(0.5); this.me.g.anchor.set(0.5); this.me.b.anchor.set(0.5);
    this.work.r.anchor.set(0.5); this.work.g.anchor.set(0.5); this.work.b.anchor.set(0.5);

    setBlendingMode(this.lab); setBlendingMode(this.me); setBlendingMode(this.work);
    ...
    resize(this.lab, menuContainerSize); resize(this.me, menuContainerSize); resize(this.work, menuContainerSize);
  ...
  private onMouseOverContainer(event) {
    event.target.filters = [new BloomFilter()];
  }
